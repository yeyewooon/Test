          ...
          <div class="contents">
            <form action="/" method="POST" id="form__wrap">
              <div class="terms__check__all">
                ...
                <label for="checkAll">HYPELAND 이용약관, 개인정보 수집 및 이용, 프로모션 정보
              ...
              <ul class="terms__list">
                <li class="terms__box">
                  <div class="input__check">
                    ...
                    <label for="termsOfService" class="required">HYPELAND 이용약관 동의</label>
                  </div>
              ...
              <span class="star" style="font-size: 0.7rem;">* 동의하지 않을 경우, 온/오프라인 회원정보 통합을 통한<br> 다양한 혜택(쿠폰, 이벤트참여 등)이 제공되지
                않을 수 있습니다.</span>
            </form>
          </div>
        </div>
        ...
        <tbody>
          ...
          <tr style="height: 70px;">
            ...
            <td colspan="2">
              ...
              <button type="button" class="btn btn-dark" id="checkId" style="height: 30px; font-size: 13px;">중복확인</button>
            </td>
          </tr>
          <tr style="height: 70px;">
            <th>
