...
<script src="https://code.jquery.com/jquery-3.6.0.js"
	...
	crossorigin="anonymous"></script>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/member/css/cart.css">
<title>장바구니</title>
</head>
			...
			<div class="container">
				...
				<div class="col-md-2 navbar-anchor" id="userIcon">
					<c:choose>
						...
						<c:otherwise>
							<!-- 로그인 안하면 -->
							<i id="loginIcon" class="fa-solid fa-cart-plus"></i>
							</a>
						...
						<c:otherwise>
							<c:forEach items="${list}" var="dto" varStatus="status">
								<tr>
									...
									<td class="col-1"><a href=""><img class="productImg"
											src="" alt=""></a></td>
									<td class="detailItem">
										<div class="row">
											<div class="col-12">
									...
									<td>
										<button class="minusBtn qty-update-btn" type="button"
											data-type="minus">-</button> <input type="number"
										class="quantity" value="${dto.cart_quantity}">
