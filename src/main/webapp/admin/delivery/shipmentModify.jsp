						...
						<div class="modifyContainer container w-100">
							...
							<div class="row mt-1">
								<div class="form-group col-md-6 mt-2">
									<label for="inputEmail4">주문 번호</label> <input type="text"
										class="form-control mt-2" id="inputEmail4"
										value="${list[0].getSeq_order()}" readonly name="seq_order" />
								</div>
								<div class="form-group col-md-6 mt-2">
									<label for="inputPassword4">회원 id</label> <input type="text"
							...
							<div class="row">
								<div class="form-group col-md-6 mt-2">
									<label for="inputEmail4">수취인 이름</label> <input type="text"
										class="form-control mt-2" id="inputEmail4"
							...
							<div class="row">
								<div class="form-group col-md-12 mt-2">
									<label for="inputEmail4"><strong>구매 목록</strong></label>
							...
							<div class="row">
								<div class="form-group col-md-12 mt-2">
									<label for="inputEmail4">배송 메세지</label> <input type="text"
										class="form-control mt-2" id="inputEmail4"
							...
							<div class="row">
								<div class="form-group col-md-12 mt-2">
									<label for="inputEmail4">사용자 입력 주소</label> <input type="text"
										class="form-control mt-2" id="inputEmail4"
							...
							<div class="row">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" id="jibunAddr"
										name="jibunAddr" placeholder="지번주소" />
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
