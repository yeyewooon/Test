...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ceab26faabf0856bb87994f6fa56aaf7"></script>
   <script>
      ...
      kakao.maps.event.addListener(marker, 'click', function () {
         ...
         var iwContent = '<div style="padding:5px;">HypeLand 종로</div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
             iwRemoveable = true; // removeable 속성을 ture 로 설정하면 인포윈도우를 닫을 수 있는 x버튼이 표시됩니다
         ...
         var iwContent = '<div style="padding:5px;">HypeLand 당산</div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
             iwRemoveable = true; // removeable 속성을 ture 로 설정하면 인포윈도우를 닫을 수 있는 x버튼이 표시됩니다
