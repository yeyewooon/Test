...
i{
        ...
        .btnOrder, .btnCart{background-color: #83bf7b; border-color: #83bf7b;}
        .clothesDetail{text-align: center; padding-top: 120px;}
        ...
        .inputCount{margin:5px; text-align: center;  padding: 0;}

        .body{padding-bottom:100px;}

        /* 상품 메뉴 */
        .detailNav{margin-top: 300px;}
        .detailNav a{text-decoration: none; color: cadetblue;}
        
        /* 상품 정보*/
        .brand{margin:auto; width: 1000px;}
...
<!-- 						<button type="button" data-bs-target="#carouselExampleIndicators"
			...
			<div class="col-md-4 clothesContent">
				...
				<div class="row clothesName p-3 m-2">
					<h2>${productDTO.getProduct_name()}</h2>
				</div>
				<div class="row clothesPrice p-3 m-2">
					...
					<div class="col-md-8 d-flex justify-content-start">
						<h6>${productDTO.getProduct_price()}원</h6>
					</div>
				</div>
...
<%--		<div class="col-12 p-2">
	...
	<div class="review" id="review">
		<div class="row m-2 reviewTableHead">
