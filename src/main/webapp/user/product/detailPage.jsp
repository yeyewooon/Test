...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
     ...
     <script src="https://code.jquery.com/jquery-3.6.0.js"></script>
      <link href="<%=request.getContextPath()%>css/detailPage.css" rel="stylesheet"/>
<title>상세페이지</title>
</head>
<body>
    ...
    <div class="body">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="images/반바지2-1.png" class="d-block w-100" alt="...">
                      </div>
            ...
            <div class="col-md-4 clothesContent">
                ...
                <div class = "row countBox p-3 m-3">
                    ...
                    <div class = "col-md-8 d-flex">
                        <button type = "button" style = "width: 40px;" class = "btn btn-secondary btnCount" value="-">-</button>
                ...
                <div class = "row orderBox p-3 m-3">
                    ...
                    <div class = "col-md-6 d-flex justify-content-start">
                        <button type = "button" class = "btn btn-secondary btnCart">장바구니 담기</button>
                    </div>
                </div>
            </div>
        </div>
       ...
       <div class = "row detailNav">
            <div class="col-12 d-flex justify-content-center">
                <ul class="link">
                    <span class="select">
                        <a href = "#clothesDetail">Detail View</a>
                    </span>
                    <span>&nbsp;&nbsp;/&nbsp;&nbsp;</span>
                    <span class="seller_detail">
                        <a href = "#brand">Brand info</a>
                    </span>
                    <span>&nbsp;&nbsp;/&nbsp;&nbsp;</span>
                    <span class="clothes_review">
    ...
    <div class = "detail" id = "detail">
        ...
        <div class="row">
            <div class="col-12">
                <p class="info_detail" style="font-size:11px;">본 상품 정보의 내용은 공정거래위원회 ‘상품정보제공고시’ 에 따라 판매자가 직접 등록한 것으로 해당 정보에 대한 책임은 판매자에게 있습니다.</p>
            </div>
        </div>
    </div>
    ...
    <script>
    	document.getElementById("write").onclick = function(){
    		...
    		let name = "리뷰 작성페이지";
    		let option = "width: 1000px, height: 500px";
